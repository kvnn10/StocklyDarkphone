...
const ProductList = React.memo(function ProductList({ initialProducts, initialStats, initialSupplierPortal }: ProductListProps = {}) {
  ...
  return <div className="flex flex-col poppins">
    ...
    {isAdminProductsPage && <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 pb-6 items-stretch">
      ...
      <StatisticsCard title="Estimated Sale Value" value={formatCurrency(warehouseInventoryStats.saleTotal)} description="Estimated sale value at current prices" icon={DollarSign} variant="violet" valueLoading={dashboardCardsLoading || warehouseCardsLoading} badgeValuesLoading={warehouseCardsLoading} badges={warehouseSaleBadges} />
      <StatisticsCard title="Inventory Value (Cost)" value={formatCurrency(warehouseInventoryStats.costTotal)} description="Total inventory at purchase cost" icon={DollarSign} variant="blue" valueLoading={dashboardCardsLoading || warehouseCardsLoading} badgeValuesLoading={warehouseCardsLoading} badges={warehouseCostBadges} />
