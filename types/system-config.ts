...
>[] = [
  ...
  },
  {
    ...
    value: "4",
    type: "number",
    label: "Stock Low — maximum quantity",
    description: "1 through this quantity is classified as low stock",
    category: "inventory",
    isPublic: false,
  },
  {
    ...
    value: "9",
    type: "number",
    label: "Stock Medium — maximum quantity",
    description: "Quantities above low stock and up to this value are classified as medium stock",
    category: "inventory",
    isPublic: false,
  },
  {
