...
|---------|-----|-------------|------------|--------|------------|--------|
| R-001 | REQ-0001 | removeChild regression on new Select | Med | Med | DeferredSelectGate on new Selects | mitigated |
...
| R-004 | REQ-0009 | Sentry case 1 product error | Med | Med | Monitor 24h post-deploy | monitoring |
